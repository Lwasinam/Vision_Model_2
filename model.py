...
class PatchEmbed(nn.Module):
    ...
    proj : nn.Conv2d
        ...
        and their embedding.
    """
    def __init__(self, img_size, patch_size, in_chans=3, embed_dim=1024, num_registers = 4):
        super().__init__()
...
def build_transformer(tgt_vocab_size: int, tgt_seq_len: int, d_model: int=1024, N: int=10, h: int=8, dropout: float=0.4, d_ff: int=3072) -> Transformer:
